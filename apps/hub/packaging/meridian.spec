...
a = Analysis(
    ...
    runtime_hooks=[],
    excludes=[
        'tkinter', '_tkinter', 'matplotlib', 'IPython', 'jedi', 'parso', 'PIL',
        ...
        'PySide6.QtLocation', 'PySide6.QtNfc', 'PySide6.QtSerialPort', 'PySide6.QtSql',
        'PySide6.QtTest', 'PySide6.QtXml', 'PySide6.QtSvgWidgets',
    ],
