...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "-mb-1.5 px-3 py-2.5 text-xs font-medium text-muted-foreground data-inset:pl-9.5",
        className
      )}
      {...props}
    />
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-pointer items-center gap-1.5 rounded-2xl border border-white/0 px-3 py-2 text-sm font-medium outline-hidden select-none focus:border-white/4 focus:!bg-foreground/2 focus:text-accent-foreground data-inset:pl-9.5 data-[variant=destructive]:!text-destructive data-[variant=destructive]:focus:!bg-destructive/10 data-[variant=destructive]:focus:text-destructive dark:data-[variant=destructive]:focus:bg-destructive/20 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 data-[variant=destructive]:*:[svg]:text-destructive",
        className
      )}
      {...props}
    />
